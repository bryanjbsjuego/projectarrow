				...
				<div class="card">
					...
					<div class="body">
                        <div class="row clearfix">
                            ...
                            @endif
                            <div class="col-md-12">
                                <form method="POST" action="{{ route('conceptosec.actualizarimagen',$imagen->id) }}" enctype="multipart/form-data" >
                                @csrf
                                @method('PUT')
                                ...
                                <input type="hidden" name="id_concepto" value="{{ $imagen->id_concepto }}">
