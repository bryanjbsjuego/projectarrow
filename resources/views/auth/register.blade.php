        ...
        <div class="card">
            ...
            <div class="col-sm-12">
                ...
                <div class="input-group">
                    ...
                    <div class="form-line">
                        <input type="password" class="form-control" name="confirm-password" minlength="6" placeholder="Confirma password" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label for="terms">Acepto los terminos y condiciones<a href="">terms of usage</a>.</label>
                </div>
