                                ...
                                <div class="row m-2">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group  drop-custum">
                                            <select class="form-control show-tick" id="tipo_empleado" name="tipo_empleado">
                                                ...
                                                <option value="em" @if ($tipo=='em') selected  @endif >Empresa</option>

                                                 <option value="cl" @if ($tipo=='cl') selected  @endif>Cliente</option>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                            ...
                                            <select class="form-control show-tick" id="cliente" name="id_cliente" required>
                                                <option value="0" selected>--Seleccione un empleado por cliente--</option>
                                                 ...
                                                 <option value="{{$cliente->id}}" @if ($asignarcargo->id_empleado == $cliente->id) selected  @endif   >{{$cliente->nombre.' '. $cliente->apellido_paterno .' '. $cliente->apellido_materno}}</option>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <select class="form-control show-tick" id="empresa" name="id_empresa" style="display: none" required>
                                            ...
                                            <option value="{{$empleado->id}}"  @if ($asignarcargo->id_empleado == $empleado->id) selected  @endif   id="opc">{{$empleado->nombre.' '. $empleado->apellido_paterno .' '. $empleado->apellido_materno}}</option>
